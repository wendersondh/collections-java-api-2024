...
public class LivrariaOnline {
    ...
    public Map<String, Livro> exibirLivrosOrdenadosPorPreco(){
        List<Map.Entry<String, Livro>> livrosParaOrdenaPorPreco = new ArrayList<>(livroMap.entrySet());
        Collections.sort(livrosParaOrdenaPorPreco, new ComparatorPorPreco());

        Map<String, Livro> livrosOrdenadosPorPreco = new LinkedHashMap<>();
        for(Map.Entry<String, Livro> entry : livrosParaOrdenaPorPreco){
